...
export const OAuthButtons = () => {
  ...
  // Temporarily disable OAuth until properly configured
  const isOAuthEnabled = false; // Set to true once OAuth is configured in Supabase
  ...
  return (
    <div className="space-y-3">
      ...
      <Button
        ...
        disabled={!isOAuthEnabled || isLoading.google || isLoading.github}
      ...
      <Button
        ...
        className={`w-full h-12 border-2 rounded-xl font-medium transition-all duration-200 flex items-center justify-center space-x-3 shadow-sm ${
          isOAuthEnabled 
            ? 'bg-gray-900 hover:bg-gray-800 text-white border-gray-900 hover:border-gray-800 hover:shadow-md' 
            : 'bg-gray-100 text-gray-400 border-gray-200 cursor-not-allowed'
        }`}
      >
        {!isOAuthEnabled ? (
          <>
            <svg className="w-5 h-5 fill-current opacity-50" viewBox="0 0 24 24">
