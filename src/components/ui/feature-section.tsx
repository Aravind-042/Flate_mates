...
export function FeatureSteps({
  ...
  return <div className={cn("p-8 md:p-12", className)}>
      <div className="max-w-7xl mx-auto w-full">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-10 text-center bg-gradient-to-r from-deep-blue via-orange to-emerald bg-clip-text text-transparent">
          {title}
        </h2>
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-10">
          <div className="order-2 md:order-1 space-y-8">
            ...
            duration: 0.5
                ...
                <motion.div className={cn("w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center border-2", index === currentFeature ? "bg-gradient-to-r from-deep-blue to-orange border-transparent text-white scale-110" : "bg-white/80 border-light-slate text-charcoal")}>
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm md:text-lg text-charcoal/80">
                    {feature.content}
                  </p>
                </div>
              </motion.div>)}
