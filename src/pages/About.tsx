  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {/* Features Section */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-12">Why Choose FlatMates?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="text-center hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="mx-auto bg-gradient-to-r from-blue-600 to-orange-500 p-3 rounded-full w-fit mb-4">
        ...
        {/* Stats Section */}
        <div className="bg-gradient-to-r from-blue-600 to-orange-500 rounded-2xl text-white p-12 mb-16">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Sign up and create a detailed profile with your preferences and requirements.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Search for flats or list your property. Connect with verified users.</p>
            </div>
            <div className="text-center">
              <div className="bg-green-100 p-4 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl font-bold text-green-600">3</span>
              </div>
              <h3 className="font-semibold mb-2">Move In Safely</h3>
              <p className="text-gray-600">Complete the process securely with our verified users and support team.</p>
            </div>
          </div>
        </div>
