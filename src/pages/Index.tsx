          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-8">
              <div className="relative inline-block">
                ...
                <div className="relative bg-gradient-to-r from-deep-blue to-orange p-6 rounded-3xl shadow-2xl">
                  <Home className="h-16 w-16 text-white" />
                </div>
              </div>
            </div>
            
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-deep-blue via-orange to-emerald bg-clip-text text-transparent">
              Find Your Perfect
              <span className="block">Flatmate Adventure</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-charcoal mb-8 max-w-2xl mx-auto font-medium">
            ...
            {user ? (
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                {profile?.role === 'flat_owner' && (
                  <Link to="/profile">
                    <Button variant="outline" className="h-14 px-8 text-lg font-semibold border-2 border-charcoal text-charcoal hover:bg-charcoal hover:text-white rounded-2xl">
              ...
              {stats.map((stat, index) => (
                <Card key={index} className="bg-white/80 backdrop-blur-md border-0 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]">
                  <CardContent className="p-8 text-center">
                    <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-deep-blue to-orange bg-clip-text text-transparent mb-2">
                      {stat.number}
                    </div>
        ...
        <section className="relative py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-deep-blue via-orange to-emerald bg-clip-text text-transparent">
